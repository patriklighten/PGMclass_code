...
for i=1:size(assignments,1)
    if (assignments(i,1)==1)
        phenotypeFactor.val(i)= alphaList(allelesToGenotypes(assignments(i,2),assignments(i,3)));
    end
    if (assignments(i,1)==2)
        phenotypeFactor.val(i)= 1-alphaList(allelesToGenotypes(assignments(i,2),assignments(i,3)));
    end 
end
