...
for i=1:size(assignments,1)
    genotypeFactor.val(1, i)=(allelesToGenotypes(genotypesToAlleles(assignments(i,2),1),genotypesToAlleles(assignments(i,3),1))==assignments(i,1))*1/4+genotypeFactor.val(1,i); 
    genotypeFactor.val(1, i)=(allelesToGenotypes(genotypesToAlleles(assignments(i,2),1),genotypesToAlleles(assignments(i,3),2))==assignments(i,1))*1/4+genotypeFactor.val(1, i);
    genotypeFactor.val(1, i)=(allelesToGenotypes(genotypesToAlleles(assignments(i,2),2),genotypesToAlleles(assignments(i,3),1))==assignments(i,1))*1/4+genotypeFactor.val(1, i);
    genotypeFactor.val(1, i)=(allelesToGenotypes(genotypesToAlleles(assignments(i,2),2),genotypesToAlleles(assignments(i,3),2))==assignments(i,1))*1/4+genotypeFactor.val(1, i);
